...
<body>
  ...
  <div class="contact_guide">
    <div class="contact_border">
      ...
      <div class="notes">
      <p class="note">ログインを行うためにメールアドレスとパスワードを入力して下さい。
      </p>
      </div>
      <div class="inputs">
        ...
        <input type="submit" name="register_complete" value="ログイン" class="register_complete">
        </div>
        </form>
      </div>
    </div>
    <div class="reset">
      <a href="{{ route('reset') }}">パスワードを忘れた方はこちら</a>
    </div>
  </div>
